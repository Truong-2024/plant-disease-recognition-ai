...
### Kết quả GradCAM++
![Kết quả nhận diện bệnh](screenshots/ketquagradcam.png)

Trong quá trình nhận diện bệnh trên lá cây cảnh bằng mô hình học sâu, Grad-CAM++ được sử dụng để trực quan hóa các vùng mà mô hình tập trung khi đưa ra dự đoán. Kết quả cho thấy Grad-CAM++ giúp xác định chính xác các vùng bị bệnh trên lá, từ đó hỗ trợ việc đánh giá hiệu quả của mô hình.
